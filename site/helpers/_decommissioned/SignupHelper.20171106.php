    ...
    function __construct()
    {
        ...
        $this->step_fields = [
            1 => [
                ...
                'caption_try15days' => [
                    'type' => 'Label',
                    'label' => '<h4 class="group highlight text-blue text-center">Try Todyl Protection Free for 15 Days!</h4>',
                ],
                'todyl_email' => [
                    'type' => 'Text',
            ...
            2 => [
                ...
                'caption_description' => [
                    'type' => 'Label',
                    'label' => '<h4 class="step_header side-line"><span>Start With Our Free 15 Day Trial</span></h4>',
                    'grid' => 'row',
                ],
                // 'package_standard' => [
                //     'type' => 'TPackageButton',
                ...
                'package_standard' => [
                    'type' => 'Label',
                    'label' => '<input type="hidden" name="package" value="standard" />',
                ],
                'separator' => [
                    'type' => 'Separator',
                    'color' => '#8a8a8a',
                ...
                'Next' => [
                    'type' => 'Submit',
                    'attributes' => [
                        'class'   => 'button btn-wide float-right',
                    ],
                ],
            ],
            3 => [
                ...
                'terms' => [
                    ...
                    'options' => [
                        'yes' => [
                            'label' => 'By clicking this checkbox you agree to the following <a target="_blank" href="/customeragreement">customer agreement</a>. Upon clicking the Complete Your Order button below, you will be charged based on the summary information provided.',
                            'value' => 'yes',
                        ],
                    ],
                    'attributes' => [
