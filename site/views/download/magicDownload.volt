<div class="row pt-2 hide-for-small-only" style="width:1200px;">
    <div class="small-12 medium-10 medium-push-1 end columns magicdownload_container">
        <h1>Get Started</h1>
            ...
            <div class="small-12 medium-6 end text-center columns download_section">
                <div class="inner_section">
                    ...
                    {% if os == 'win' %}
                        ...
                        <div class="pt-1"><a class="button" href="javascript:void(0);" onclick="javascript:startMagicDownload()">Download for Windows</a></div>
                        <a href="?os=mac">Need it for Mac?</a>
                    {% elseif os == 'mac' %}
                        <img src="/img/download/apple-icon.png" /><br />
                        <div class="pt-1"><a class="button" href="javascript:void(0);" onclick="javascript:startMagicDownload()">Download for Mac</a></div>
        ...
        <p class="text-mid-grey pt-2">Having Trouble? Check out the <a href="/support">Frequently Asked Questions</a>.</p>
    </div>
</div>
